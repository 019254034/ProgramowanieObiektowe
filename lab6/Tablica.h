...
public:
	...
	Komorka** stworz_tablice(int rozmiar_x, int rozmiar_y);
	void zmien_rozmiar(int nowy_rozmiar_x, int nowy_rozmiar_y);
	void aktualizuj_element(int wspolrzedna_x, int wspolrzedna_y, void* nowa_wartosc);
	...
	void wyswietl_element_liczbowy(int wspolrzedna_x, int wspolrzedna_y);
	void wyswietl_element_tekstowy(int wspolrzedna_x, int wspolrzedna_y);
